...
import { NameSelectCidadeController } from "@modules/comum/use-cases/cidade/name-select-cidade/name-select-cidade-controller"
...
const nameSelectCidadeController = new NameSelectCidadeController()
...
cidadesRoutes.get("/select-name", ensureAuthenticated, nameSelectCidadeController.handle)
