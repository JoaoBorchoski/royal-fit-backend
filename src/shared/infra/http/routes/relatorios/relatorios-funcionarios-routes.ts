...
import { CreateRelatorioDataAndFuncionarioController } from "@modules/relatorios/use-cases/relatorio-funcionario/create-relatorio-by-data-and-funcionario/create-relatorio-by-data-and-funcionario-controller"
...
const createRelatorioDataAndFuncionarioController = new CreateRelatorioDataAndFuncionarioController()

relatoriosFuncionariosRoutes.post("/", ensureAuthenticated, createRelatorioFuncionarioController.handle)
relatoriosFuncionariosRoutes.post("/:id", ensureAuthenticated, createRelatorioDataAndFuncionarioController.handle)
