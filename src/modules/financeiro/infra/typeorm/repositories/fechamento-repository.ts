...
class FechamentoRepository implements IFechamentoRepository {
  ...
  `)
      ...
      const despesasUltimas4Semanas = despesas.filter((d) => new Date(d.data) >= new Date(Date.now() - 4 * 7 * 24 * 60 * 60 * 1000))
      const entradasUltimas4Semanas = entradas.filter((d) => new Date(d.data) >= new Date(Date.now() - 4 * 7 * 24 * 60 * 60 * 1000))
      ...
      const despesasUltimos7Dias = despesas.filter((d) => new Date(d.data) >= new Date(Date.now() - 7 * 24 * 60 * 60 * 1000))
      const entradasUltimos7Dias = entradas.filter((d) => new Date(d.data) >= new Date(Date.now() - 7 * 24 * 60 * 60 * 1000))
