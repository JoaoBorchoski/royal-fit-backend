...
@injectable()
class ExportPedidoExcelUseCase {
  constructor() {}
  ...
  private exportEmptyExcel(sheetName: string) {
    const header = ["pedido", "clienteCPF/CNPJ", "funcionarioCPF", "produto", "quantidade", "data", "valorTotal", "pago"]
...
export { ExportPedidoExcelUseCase }
